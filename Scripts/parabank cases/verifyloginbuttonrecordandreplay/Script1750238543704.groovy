...
WebUI.setText(findTestObject('Object Repository/Page_ParaBank  Error/input_Username_username'), 'gundalavamsi005@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_ParaBank  Error/input_Password_password'), 'vEH9xfuS8xxO9Y26bS+irA==')
